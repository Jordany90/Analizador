...
import analizador.lexico.AnalisisLexico;
...
//"}\n");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tablas = analizador.tablaLexico.stream().map((s) -> s.token+"\t\t\t"+s.expresionRegular+"\t\t\t"+s.lexema+"\t\t\t"+s.linea+"\t\t\t"+s.columna+"\n").reduce(tablas, String::concat);
        
        tablas += "----------ERRORES LEXICOS----------\n";
        tablas = analizador.errorLexico.stream().map((e) -> e+"\n").reduce(tablas, String::concat);
